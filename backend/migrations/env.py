"""Alembic Environment Configuration for Mental Health Companion"""
...
# Only import SQLAlchemy models (not Pydantic models)
...
def run_migrations_online() -> None:
    ...
    """
    # Override the ini file sqlalchemy.url with environment variable
